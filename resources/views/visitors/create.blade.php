<form method="POST" action="{{ route('visitor.create') }}" enctype="application/x-www-form-urlencoded">
    @csrf
    ...
    <div class="form-group row">
        <strong for="license_plate" class="col-md-4 col-form-label text-md-right">{{ __('License Plate') }}</strong>

        <div class="col-md-6">
            <input id="license_plate" type="text" class="form-control @error('license_plate') is-invalid @enderror shadow" name="license_plate" value="{{ old('license_plate') }}">
